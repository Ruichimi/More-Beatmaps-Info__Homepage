...
<template>
  <div class="flex justify-center py-20 px-4 mb-30">
    <div
        class="w-full max-w-xl rounded-2xl border border-pink-500/40 bg-gradient-to-br
         from-purple-900/60 to-purple-950/80 p-6 shadow-xl backdrop-blur">
      ...
      <transition
        ...
        <div v-if="type === 'question'" class="mb-4">
          <input
              ...
              class="w-full rounded-xl bg-purple-900/70 border px-4 py-2 text-white placeholder-purple-400
      ...
      <textarea
          v-model="message"
          rows="4"
          class="w-full rounded-xl bg-purple-900/70 border border-purple-700 px-4 py-3 text-white
